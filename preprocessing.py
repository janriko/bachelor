...
def do_preprocessing(pipeline_type: PipelineType, game: GameType = GameType.ALL, remove_labels: bool = False) -> (DatasetDict, DatasetDict):
    """
    ...
    """
    # test_set = "JerichoWorld-main/data/small_test_set.json"
    test_set = "JerichoWorld-main/data/separate/" + game.value + ".json"
    ...
    """
    tokenized_datasets: DatasetDict = file_loader.get_tokenized_text_and_graph_ids(pipeline_type, dataset_dict, remove_labels, game)
