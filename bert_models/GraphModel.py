...
from transformers import GPT2Config, EncoderDecoderConfig, EncoderDecoderModel, BertModel, GPT2LMHeadModel
...
def get_encoder_decoder_model(encoder, decoder) -> EncoderDecoderModel:
    ...
    encoder_decoder_config.decoder_start_token_id = 2
    encoder_decoder_config.pad_token_id = 4
...
def get_graph_encoder_model() -> BertModel:
    graph_encoder_model: BertModel = BertModel.from_pretrained("./text_graph_encoder_pretrained_1024/")
